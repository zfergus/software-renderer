...
if(TARGET software_renderer::warnings)
    return()
endif()

set(SOFTWARE_RENDERER_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(software_renderer_warnings INTERFACE)
add_library(software_renderer::warnings ALIAS software_renderer_warnings)

foreach(FLAG IN ITEMS ${SOFTWARE_RENDERER_FLAGS})
    ...
    if(IS_SUPPORTED_${FLAG_VAR})
        target_compile_options(software_renderer_warnings INTERFACE ${FLAG})
    endif()
endforeach()
